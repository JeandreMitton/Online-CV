...
class Particle {
    ...
    update() {
        ...
        if (this.x > canvas.width || this.x < 0){
            ...
            this.speedX = this.directionX;
	    } if (this.y + this.size > canvas.height || this.y - this.size < 0 || this.y == 500){
		    this.directionY = -this.directionY;
            this.speedY = this.directionY;
        } if ((this.x >= 280 && this.x <= 800) && (this.y >= 500 && this.y <= 800)){
            this.directionX = -this.directionX;
            this.speedX = this.directionX;
            this.directionY = -this.directionY;
            this.speedY = this.directionY;
    ...
    for (let a = 0; a < particleArray.length; a++) {
        for (let b = a; b < particleArray.length; b++){
            ...
            {   
                ...
                ctx.strokeStyle='rgba(80,0,80,' + opacityValue +')';
                ctx.beginPath();
                ctx.lineWidth = 5;
